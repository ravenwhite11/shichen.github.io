...
class Leaderboard extends React.Component {
  ...
  getData() {
    ...
    let data = {
      success: true,
      leaders: [
      { id: 1, name: '黑巧克力', score: 480 },
      { id: 3, name: '珍珠奶茶', score: 400 },
      { id: 2, name: '抹茶', score: 290 },
/*      { id: 4, name: '草莓', score: 200 },
      { id: 5, name: '白巧克力', score: 175 }*/
      ],
      maxScore: 500 };
  ...
  render() {
    return (
      ...
      /*React.createElement("h2", null, "銷售數量(顆)"),*/
      ...
      React.createElement("div", { className: "leader-name" }, el.name),
